package com.ytplayer.subscribe.example1old;
...
import static com.ytplayer.R.id.playerView;
...
public class YouTubeSubscribeActivity extends AppCompatActivity implements YouTubePlayer.OnInitializedListener, EasyPermissions.PermissionCallbacks, YouTubeActivityView {
    ...
    private static final String PREF_ACCOUNT_NAME = "YTPlayer";
    private static final String WANT_TO_SUBSCRIBE_CHANNEL_ID = "UCFjKJ89L4A_0c0QyaiCA5Hg";
//    private static final String SCOPE = "https://www.googleapis.com/auth/youtube";
    ...
    ;
    private String youtubeKey = "AIzaSyASYotxuudMTkBLznDtMnBgzEeZhHAufhg";// paste your youtube key here
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String emailId = getIntent().getExtras().getString(GoogleSignInActivity2.USER_EMAIL);
    ...
    private void getResultsFromApi() {
        ...
        if (!isGooglePlayServicesAvailable()) {
            ...
            presenter.subscribeToYouTubeChannel(mCredential, WANT_TO_SUBSCRIBE_CHANNEL_ID); // pass youtube channelId as second parameter
        }
    ...
    public void onSubscribetionFail() {
        ...
        if (counter < 3) {
            ...
            GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                    .requestEmail()
                    .requestScopes(new Scope(SCOPE)) // require this scope for youtube channel subscribe
                    .build();
